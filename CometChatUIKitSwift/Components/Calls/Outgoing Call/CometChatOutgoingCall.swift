...
open class CometChatOutgoingCall: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        CallingDefaultBuilder.setIsAudioOnly(call?.callType == .audio)
        if CallingDefaultBuilder.callSettingsBuilder != nil {
            print("CallingDefaultBuilder.callSettingsBuilder-2")
        } else {
                print("CallingDefaultBuilder.callSettingsBuilder-2 is nil")
        }
