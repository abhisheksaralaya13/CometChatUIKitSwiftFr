...
@objc @IBDesignable class ActionSheetHeaderView: UIView , NibLoadable {
    ...
    private func commonInit() {
        ...
        title.font = CometChatTheme.typography.heading
        
        close.setTitle("CLOSE".localize(), for: .normal)
        close.titleLabel?.font = CometChatTheme.typography.title2
        layoutMode.tintColor = CometChatTheme.palatte.primary
    ...
    public func set(style: ActionSheetStyle) -> Self {
        set(layoutModeTint: style.layoutModeIconTint)
        set(titleFont: style.titleFont)
        set(titleColor: style.titleColor)
        set(backgroundColor: [style.background.cgColor])
        set(closeTitleColor: style.cancelButtonIconTint)
        set(closTitleFont: style.cancelButtonIconFont)
        return self
    }
    ...
    @discardableResult
    public func set(closTitleFont: UIFont) -> Self {
        close.titleLabel?.font = closTitleFont
        return self
    }
    
    @discardableResult
    public func set(closeTitleColor: UIColor) -> Self {
        close.setTitleColor(closeTitleColor, for: .normal)
        return self
    }
    
    @discardableResult
    public func set(layoutModeTint: UIColor) -> Self {
        layoutMode.setTitleColor(layoutModeTint, for: .normal)
        layoutMode.backgroundColor = .black
        return self
    }
